...
class Init_Target_aim_z
{
public:
  explicit Init_Target_aim_z(::auto_aim_interfaces::msg::Target & msg)
  : msg_(msg)
  {}
  ::auto_aim_interfaces::msg::Target aim_z(::auto_aim_interfaces::msg::Target::_aim_z_type arg)
  {
...
class Init_Target_aim_y
{
public:
  explicit Init_Target_aim_y(::auto_aim_interfaces::msg::Target & msg)
  : msg_(msg)
  {}
  Init_Target_aim_z aim_y(::auto_aim_interfaces::msg::Target::_aim_y_type arg)
  {
    msg_.aim_y = std::move(arg);
    return Init_Target_aim_z(msg_);
  }
...
class Init_Target_aim_x
{
public:
  explicit Init_Target_aim_x(::auto_aim_interfaces::msg::Target & msg)
  : msg_(msg)
  {}
  Init_Target_aim_y aim_x(::auto_aim_interfaces::msg::Target::_aim_x_type arg)
  {
    msg_.aim_x = std::move(arg);
    return Init_Target_aim_y(msg_);
  }
...
class Init_Target_pre_yaw
{
public:
  explicit Init_Target_pre_yaw(::auto_aim_interfaces::msg::Target & msg)
  : msg_(msg)
  {}
  Init_Target_aim_x pre_yaw(::auto_aim_interfaces::msg::Target::_pre_yaw_type arg)
  {
    msg_.pre_yaw = std::move(arg);
    return Init_Target_aim_x(msg_);
  }
...
class Init_Target_pre_pitch
{
public:
  explicit Init_Target_pre_pitch(::auto_aim_interfaces::msg::Target & msg)
  : msg_(msg)
  {}
  Init_Target_pre_yaw pre_pitch(::auto_aim_interfaces::msg::Target::_pre_pitch_type arg)
  {
    msg_.pre_pitch = std::move(arg);
    return Init_Target_pre_yaw(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_Target_pre_pitch dz(::auto_aim_interfaces::msg::Target::_dz_type arg)
  {
    msg_.dz = std::move(arg);
    return Init_Target_pre_pitch(msg_);
  }
