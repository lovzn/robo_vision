...
class Target(metaclass=Metaclass_Target):
    ...
    def __init__(self, **kwargs):
        ...
        self.pre_pitch = kwargs.get('pre_pitch', float())
        self.pre_yaw = kwargs.get('pre_yaw', float())
    ...
    def __eq__(self, other):
        ...
        if self.dz != other.dz:
            return False
        if self.pre_pitch != other.pre_pitch:
            return False
        if self.pre_yaw != other.pre_yaw:
            return False
    ...
    @builtins.property
    def pre_pitch(self):
        """Message field 'pre_pitch'."""
        return self._pre_pitch

    @pre_pitch.setter
    def pre_pitch(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'pre_pitch' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'pre_pitch' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._pre_pitch = value

    @builtins.property
    def pre_yaw(self):
        """Message field 'pre_yaw'."""
        return self._pre_yaw

    @pre_yaw.setter
    def pre_yaw(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'pre_yaw' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'pre_yaw' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._pre_yaw = value
