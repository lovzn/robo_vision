...
bool auto_aim_interfaces__msg__target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // pre_pitch
    PyObject * field = PyObject_GetAttrString(_pymsg, "pre_pitch");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->pre_pitch = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // pre_yaw
    PyObject * field = PyObject_GetAttrString(_pymsg, "pre_yaw");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->pre_yaw = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // aim_x
...
PyObject * auto_aim_interfaces__msg__target__convert_to_py(void * raw_ros_message)
{
  ...
  {  // pre_pitch
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->pre_pitch);
    {
      int rc = PyObject_SetAttrString(_pymessage, "pre_pitch", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // pre_yaw
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->pre_yaw);
    {
      int rc = PyObject_SetAttrString(_pymessage, "pre_yaw", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
