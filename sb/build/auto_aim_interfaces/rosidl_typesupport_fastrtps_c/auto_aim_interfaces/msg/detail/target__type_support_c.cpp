  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: pre_pitch
  {
    cdr << ros_message->pre_pitch;
  }

  // Field name: pre_yaw
  {
    cdr << ros_message->pre_yaw;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name pre_pitch
  {
    size_t item_size = sizeof(ros_message->pre_pitch);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name pre_yaw
  {
    size_t item_size = sizeof(ros_message->pre_yaw);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name aim_x
